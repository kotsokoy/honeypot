...
-- Généré le : Mar 07 Avril 2015 à 16:33
...
--
CREATE DATABASE `honeypot` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `honeypot`;
...
('def', 'honeypot', 'appareils', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'notice_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'categorie_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'marque_id', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'nom', 5, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'annee_prod', 6, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'photo', 7, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'creation', 8, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'appareils', 'description', 9, NULL, 'NO', 'varchar', 160, 480, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(160)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'categories', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'honeypot', 'categories', 'nom', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'marques', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'honeypot', 'marques', 'nom', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'marques', 'logo', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'notices', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'honeypot', 'notices', 'fichier', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'notices', 'langue', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'nom', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'roles', 3, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'mdp', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'salt', 5, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'email', 6, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'honeypot', 'users', 'creation', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
...
('def', 'test', 'advert_categorie', 'advert_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test', 'advert_categorie', 'categorie_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'test', 'advertskill', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'advertskill', 'advert_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'test', 'advertskill', 'skill_id', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'test', 'advertskill', 'level', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'date', 2, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'title', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'author', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'content', 5, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'published', 6, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_advert', 'image_id', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_candidature', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'kotso_candidature', 'advert_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_candidature', 'author', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_candidature', 'content', 4, NULL, 'NO', 'longtext', 4294967295, 4294967295, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'longtext', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_candidature', 'date', 5, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_categorie', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'kotso_categorie', 'name', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_image', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'kotso_image', 'url', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'kotso_image', 'alt', 3, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'skill', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'skill', 'name', 2, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '133'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '4'),
('HANDLER_READ_RND_NEXT', '3553'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '2'),
('HANDLER_WRITE', '2905'),
('INNODB_BUFFER_POOL_PAGES_DATA', '356'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '90'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7835'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '7805'),
('INNODB_BUFFER_POOL_READS', '354'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '148'),
('INNODB_DATA_FSYNCS', '32'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '7983104'),
('INNODB_DATA_READS', '364'),
('INNODB_DATA_WRITES', '70'),
('INNODB_DATA_WRITTEN', '1490944'),
('INNODB_DBLWR_PAGES_WRITTEN', '45'),
('INNODB_DBLWR_WRITES', '7'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '16'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '21477'),
('UPTIME_SINCE_FLUSH_STATUS', '21477');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\F-MGE.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\F-MGE.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.20\\data\\F-MGE-slow.log'),
...
('def', 'honeypot', 'PRIMARY', 'def', 'honeypot', 'appareils', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'honeypot', 'FK_E6295C114827B9B2', 'def', 'honeypot', 'appareils', 'marque_id', 1, 1, 'honeypot', 'marques', 'id'),
('def', 'honeypot', 'FK_E6295C117D540AB', 'def', 'honeypot', 'appareils', 'notice_id', 1, 1, 'honeypot', 'notices', 'id'),
('def', 'honeypot', 'FK_E6295C11BCF5E72D', 'def', 'honeypot', 'appareils', 'categorie_id', 1, 1, 'honeypot', 'categories', 'id'),
('def', 'honeypot', 'PRIMARY', 'def', 'honeypot', 'categories', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'honeypot', 'PRIMARY', 'def', 'honeypot', 'marques', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'honeypot', 'PRIMARY', 'def', 'honeypot', 'notices', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'honeypot', 'PRIMARY', 'def', 'honeypot', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'test', 'PRIMARY', 'def', 'test', 'advert_categorie', 'advert_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'advert_categorie', 'categorie_id', 2, NULL, NULL, NULL, NULL),
('def', 'test', 'FK_D340C738BCF5E72D', 'def', 'test', 'advert_categorie', 'categorie_id', 1, 1, 'test', 'kotso_categorie', 'id'),
('def', 'test', 'FK_D340C738D07ECCB6', 'def', 'test', 'advert_categorie', 'advert_id', 1, 1, 'test', 'kotso_advert', 'id'),
('def', 'test', 'PRIMARY', 'def', 'test', 'advertskill', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'FK_D6575F25585C142', 'def', 'test', 'advertskill', 'skill_id', 1, 1, 'test', 'skill', 'id'),
('def', 'test', 'FK_D6575F2D07ECCB6', 'def', 'test', 'advertskill', 'advert_id', 1, 1, 'test', 'kotso_advert', 'id'),
('def', 'test', 'PRIMARY', 'def', 'test', 'kotso_advert', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'UNIQ_EED0C8843DA5256D', 'def', 'test', 'kotso_advert', 'image_id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'FK_EED0C8843DA5256D', 'def', 'test', 'kotso_advert', 'image_id', 1, 1, 'test', 'kotso_image', 'id'),
('def', 'test', 'PRIMARY', 'def', 'test', 'kotso_candidature', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'FK_4DD5D907D07ECCB6', 'def', 'test', 'kotso_candidature', 'advert_id', 1, 1, 'test', 'kotso_advert', 'id'),
('def', 'test', 'PRIMARY', 'def', 'test', 'kotso_categorie', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'kotso_image', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'skill', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2015-04-07 16:33:30', NULL, NULL, NULL, '', '', NULL),
('def', 'honeypot', 'appareils', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, 1820, 16384, NULL, 49152, 6291456, '2015-03-23 17:05:57', NULL, NULL, NULL, '', '', NULL),
('def', 'honeypot', 'categories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 6291456, '2015-03-23 17:05:57', NULL, NULL, NULL, '', '', NULL),
('def', 'honeypot', 'marques', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 6291456, '2015-03-23 17:05:58', NULL, NULL, NULL, '', '', NULL),
('def', 'honeypot', 'notices', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 6291456, '2015-03-23 17:05:58', NULL, NULL, NULL, '', '', NULL),
('def', 'honeypot', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 6291456, '2015-04-07 16:01:10', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:18', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:18', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1028, 9, 9252, 2533274790395903, 19456, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 867, 440716, 281474976710655, 20480, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 66, 264, 281474976710655, 2048, 0, '2011-12-16 21:03:08', '2015-02-13 17:31:21', NULL, NULL, '', '', NULL),
...
('def', 'test', 'advert_categorie', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 32768, 0, '2015-02-17 16:54:48', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'advertskill', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1260, 16384, NULL, 32768, 0, '2015-02-18 16:58:42', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'kotso_advert', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 16384, 0, '2015-02-16 10:47:34', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'kotso_candidature', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2015-02-17 15:19:24', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'kotso_categorie', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 0, '2015-02-17 16:54:48', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'kotso_image', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2015-02-17 14:12:32', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'skill', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1260, 16384, NULL, 0, 0, '2015-02-18 16:49:58', NULL, NULL, NULL, '', '', NULL);
...
(80, 'root', 'localhost:3495', 'honeypot', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'honeypot', 'FK_E6295C114827B9B2', 'def', 'honeypot', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'appareils', 'marques'),
('def', 'honeypot', 'FK_E6295C117D540AB', 'def', 'honeypot', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'appareils', 'notices'),
('def', 'honeypot', 'FK_E6295C11BCF5E72D', 'def', 'honeypot', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'appareils', 'categories'),
('def', 'test', 'FK_D340C738BCF5E72D', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'CASCADE', 'advert_categorie', 'kotso_categorie'),
('def', 'test', 'FK_D340C738D07ECCB6', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'CASCADE', 'advert_categorie', 'kotso_advert'),
('def', 'test', 'FK_D6575F25585C142', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'advertskill', 'skill'),
('def', 'test', 'FK_D6575F2D07ECCB6', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'advertskill', 'kotso_advert'),
('def', 'test', 'FK_EED0C8843DA5256D', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'kotso_advert', 'kotso_image'),
('def', 'test', 'FK_4DD5D907D07ECCB6', 'def', 'test', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'kotso_candidature', 'kotso_advert');
...
('def', 'honeypot', 'utf8', 'utf8_unicode_ci', NULL),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '2336'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2369'),
('INNODB_BUFFER_POOL_PAGES_DATA', '364'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '90'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7827'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '8391'),
...
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8114176'),
('INNODB_DATA_READS', '372'),
('INNODB_DATA_WRITES', '70'),
('INNODB_DATA_WRITTEN', '1490944'),
('INNODB_DBLWR_PAGES_WRITTEN', '45'),
('INNODB_DBLWR_WRITES', '7'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '21478'),
('UPTIME_SINCE_FLUSH_STATUS', '21478');
...
('def', 'honeypot', 'appareils', 0, 'honeypot', 'PRIMARY', 1, 'id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'honeypot', 'appareils', 1, 'honeypot', 'IDX_E6295C117D540AB', 1, 'notice_id', 'A', 9, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'honeypot', 'appareils', 1, 'honeypot', 'IDX_E6295C11BCF5E72D', 1, 'categorie_id', 'A', 9, NULL, NULL, '', 'BTREE', '', ''),
('def', 'honeypot', 'appareils', 1, 'honeypot', 'IDX_E6295C114827B9B2', 1, 'marque_id', 'A', 9, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'honeypot', 'categories', 0, 'honeypot', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'honeypot', 'marques', 0, 'honeypot', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'honeypot', 'notices', 0, 'honeypot', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', 'honeypot', 'users', 0, 'honeypot', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'test', 'advert_categorie', 0, 'test', 'PRIMARY', 1, 'advert_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'advert_categorie', 0, 'test', 'PRIMARY', 2, 'categorie_id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'advert_categorie', 1, 'test', 'IDX_D340C738D07ECCB6', 1, 'advert_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'advert_categorie', 1, 'test', 'IDX_D340C738BCF5E72D', 1, 'categorie_id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'advertskill', 0, 'test', 'PRIMARY', 1, 'id', 'A', 13, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'advertskill', 1, 'test', 'IDX_D6575F2D07ECCB6', 1, 'advert_id', 'A', 2, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'test', 'advertskill', 1, 'test', 'IDX_D6575F25585C142', 1, 'skill_id', 'A', 13, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'test', 'kotso_advert', 0, 'test', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'kotso_advert', 0, 'test', 'UNIQ_EED0C8843DA5256D', 1, 'image_id', 'A', 2, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'test', 'kotso_candidature', 0, 'test', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'kotso_candidature', 1, 'test', 'IDX_4DD5D907D07ECCB6', 1, 'advert_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'kotso_categorie', 0, 'test', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'kotso_image', 0, 'test', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'skill', 0, 'test', 'PRIMARY', 1, 'id', 'A', 13, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-07 16:33:30', '2015-04-07 16:33:30', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2015-04-07 16:33:30', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'honeypot', 'appareils', 'BASE TABLE', 'InnoDB', 10, 'Compact', 9, 1820, 16384, 0, 49152, 6291456, 10, '2015-03-23 17:05:57', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'honeypot', 'categories', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 5, '2015-03-23 17:05:57', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'honeypot', 'marques', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 5, '2015-03-23 17:05:58', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'honeypot', 'notices', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 6291456, 8, '2015-03-23 17:05:58', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'honeypot', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, 1, '2015-04-07 16:01:10', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:18', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:18', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:18', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:18', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1028, 9, 9252, 2533274790395903, 19456, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 867, 440716, 281474976710655, 20480, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 07:47:20', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 66, 264, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:08', '2015-02-13 17:31:21', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'test', 'advert_categorie', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 32768, 6291456, NULL, '2015-02-17 16:54:48', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'advertskill', 'BASE TABLE', 'InnoDB', 10, 'Compact', 13, 1260, 16384, 0, 32768, 6291456, 14, '2015-02-18 16:58:42', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'kotso_advert', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 16384, 6291456, 9, '2015-02-16 10:47:34', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'kotso_candidature', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, 1, '2015-02-17 15:19:24', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'kotso_categorie', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 6291456, 9, '2015-02-17 16:54:48', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'kotso_image', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, 1, '2015-02-17 14:12:32', NULL, NULL, 'utf8_unicode_ci', NULL, '', ''),
('def', 'test', 'skill', 'BASE TABLE', 'InnoDB', 10, 'Compact', 13, 1260, 16384, 0, 0, 6291456, 14, '2015-02-18 16:49:58', NULL, NULL, 'utf8_unicode_ci', NULL, '', '');
...
('def', 'honeypot', 'PRIMARY', 'honeypot', 'appareils', 'PRIMARY KEY'),
('def', 'honeypot', 'FK_E6295C114827B9B2', 'honeypot', 'appareils', 'FOREIGN KEY'),
('def', 'honeypot', 'FK_E6295C117D540AB', 'honeypot', 'appareils', 'FOREIGN KEY'),
('def', 'honeypot', 'FK_E6295C11BCF5E72D', 'honeypot', 'appareils', 'FOREIGN KEY'),
('def', 'honeypot', 'PRIMARY', 'honeypot', 'categories', 'PRIMARY KEY'),
('def', 'honeypot', 'PRIMARY', 'honeypot', 'marques', 'PRIMARY KEY'),
('def', 'honeypot', 'PRIMARY', 'honeypot', 'notices', 'PRIMARY KEY'),
('def', 'honeypot', 'PRIMARY', 'honeypot', 'users', 'PRIMARY KEY'),
...
('def', 'test', 'PRIMARY', 'test', 'advert_categorie', 'PRIMARY KEY'),
('def', 'test', 'FK_D340C738BCF5E72D', 'test', 'advert_categorie', 'FOREIGN KEY'),
('def', 'test', 'FK_D340C738D07ECCB6', 'test', 'advert_categorie', 'FOREIGN KEY'),
('def', 'test', 'PRIMARY', 'test', 'advertskill', 'PRIMARY KEY'),
('def', 'test', 'FK_D6575F25585C142', 'test', 'advertskill', 'FOREIGN KEY'),
('def', 'test', 'FK_D6575F2D07ECCB6', 'test', 'advertskill', 'FOREIGN KEY'),
('def', 'test', 'PRIMARY', 'test', 'kotso_advert', 'PRIMARY KEY'),
('def', 'test', 'UNIQ_EED0C8843DA5256D', 'test', 'kotso_advert', 'UNIQUE'),
('def', 'test', 'FK_EED0C8843DA5256D', 'test', 'kotso_advert', 'FOREIGN KEY'),
('def', 'test', 'PRIMARY', 'test', 'kotso_candidature', 'PRIMARY KEY'),
('def', 'test', 'FK_4DD5D907D07ECCB6', 'test', 'kotso_candidature', 'FOREIGN KEY'),
('def', 'test', 'PRIMARY', 'test', 'kotso_categorie', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'kotso_image', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'skill', 'PRIMARY KEY');
...
('localhost', 'root', '*9F2204B4C855DF2AE5B40A3047ED98AFD6BC4921', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', ''),
...
--
-- Structure de la table `advert_categorie`
--

CREATE TABLE IF NOT EXISTS `advert_categorie` (
  `advert_id` int(11) NOT NULL,
  `categorie_id` int(11) NOT NULL,
  PRIMARY KEY (`advert_id`,`categorie_id`),
  KEY `IDX_D340C738D07ECCB6` (`advert_id`),
  KEY `IDX_D340C738BCF5E72D` (`categorie_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Contenu de la table `advert_categorie`
--

INSERT INTO `advert_categorie` (`advert_id`, `categorie_id`) VALUES
(5, 1),
(5, 2),
(5, 3),
(5, 4),
...
--
-- Contenu de la table `advertskill`
--

INSERT INTO `advertskill` (`id`, `advert_id`, `skill_id`, `level`) VALUES
(1, 5, 1, 'Low'),
(2, 5, 2, 'Middle'),
(3, 5, 3, 'PGM'),
(4, 5, 4, 'Noob'),
...
--
-- Structure de la table `kotso_advert`
--

CREATE TABLE IF NOT EXISTS `kotso_advert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_EED0C8843DA5256D` (`image_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=9 ;

--
-- Contenu de la table `kotso_advert`
--

INSERT INTO `kotso_advert` (`id`, `date`, `title`, `author`, `content`, `published`, `image_id`) VALUES
(1, '2015-02-18 00:00:00', 'Developpeur PHP', 'Kotsokoy', 'Recherche Developpeur PHP connaissant la POO sur PHP5', 0, NULL),
(2, '0000-00-00 00:00:00', 'Developpeur JavaScript', 'Kotsokoy', 'Recherche Developpeur JavaScript confirme connaissant le prototypage et les méthodes AJAX''', 0, NULL),
(3, '2015-02-18 00:00:00', 'Developpeur PHP', 'Kotsokoy', 'Recherche Developpeur PHP connaissant la POO sur PHP5', 1, NULL),
(4, '2015-02-18 00:00:00', 'Développeru JS', 'Kotsokoy', 'Recherche Developpeur JavaScript confirme connaissant le prototypage et les méthodes AJAX', 1, NULL),
(5, '2015-02-18 00:00:00', 'Développeurs', 'Denis B.', 'Recherche une équipe de développeur pour travailler sur Symfony2', 1, NULL),
(6, '2015-02-18 00:00:00', 'Homme(s) jeune(s) et vigoureu(x)', 'Muriel Temime', 'Recherche un ou plusieurs hommes agés de 20 à 25 ans pour s\\''occuper de moi ASAP', 1, NULL),
(7, '2015-02-18 00:00:00', 'FORZA !', 'Alberto M.', 'Recherche un éplucheur de tomate (10 d\\''XP minimum) pour préparer des pizzas, des pates et des lasagnes', 1, NULL),
(8, '2015-02-18 00:00:00', 'Boeing 747', 'Denis B.', 'Recherche formateur pour cours de pilotage sur Jumbo Jet 747', 1, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `kotso_candidature`
--

CREATE TABLE IF NOT EXISTS `kotso_candidature` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `advert_id` int(11) NOT NULL,
  `author` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `content` longtext COLLATE utf8_unicode_ci NOT NULL,
  `date` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IDX_4DD5D907D07ECCB6` (`advert_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Structure de la table `kotso_categorie`
--

CREATE TABLE IF NOT EXISTS `kotso_categorie` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `kotso_categorie`
--

INSERT INTO `kotso_categorie` (`id`, `name`) VALUES
(1, 'Développeur'),
(2, 'Chef de Projet'),
(3, 'Gestionnaire'),
(4, 'Pilote'),
(5, 'Sportif'),
(6, 'Eplucheur de tomate'),
(7, 'Coureur de jupons'),
(8, 'Sosie');
...
--
-- Structure de la table `kotso_image`
--

CREATE TABLE IF NOT EXISTS `kotso_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contraintes pour la table `advert_categorie`
--
ALTER TABLE `advert_categorie`
  ADD CONSTRAINT `FK_D340C738BCF5E72D` FOREIGN KEY (`categorie_id`) REFERENCES `kotso_categorie` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_D340C738D07ECCB6` FOREIGN KEY (`advert_id`) REFERENCES `kotso_advert` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `advertskill`
  ...
  ADD CONSTRAINT `FK_D6575F2D07ECCB6` FOREIGN KEY (`advert_id`) REFERENCES `kotso_advert` (`id`);

--
-- Contraintes pour la table `kotso_advert`
--
ALTER TABLE `kotso_advert`
  ADD CONSTRAINT `FK_EED0C8843DA5256D` FOREIGN KEY (`image_id`) REFERENCES `kotso_image` (`id`);

--
-- Contraintes pour la table `kotso_candidature`
--
ALTER TABLE `kotso_candidature`
  ADD CONSTRAINT `FK_4DD5D907D07ECCB6` FOREIGN KEY (`advert_id`) REFERENCES `kotso_advert` (`id`);
