 ...
 */
class Notice extends \GGG\Bundle\NoticesBundle\Entity\Notice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GGG\\Bundle\\NoticesBundle\\Entity\\Notice' . "\0" . 'id', '' . "\0" . 'GGG\\Bundle\\NoticesBundle\\Entity\\Notice' . "\0" . 'fichier', '' . "\0" . 'GGG\\Bundle\\NoticesBundle\\Entity\\Notice' . "\0" . 'langue');
        }
