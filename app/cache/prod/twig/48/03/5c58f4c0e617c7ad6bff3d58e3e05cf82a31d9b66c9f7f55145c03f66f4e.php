...
<img src=\"/bundles/gggnotices/images/";
        // line 12
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "photo", array()), "html", null, true);
        echo ".jpg\" alt=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "nom", array()), "html", null, true);
        echo "\"/>
<!--p class=\"description\">";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "description", array()), "html", null, true);
        echo "</p-->
...
<a href=\"/bundles/gggnotices/notices/";
            // line 17
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "notice", array()), "fichier", array()), "html", null, true);
            echo ".pdf\" title=\"notice pour ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "nom", array()), "html", null, true);
            echo "\">
Télécharger la notice de ";
            // line 18
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "categorie", array()), "nom", array())), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "marque", array()), "nom", array())), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getAttribute((isset($context["appareil"]) ? $context["appareil"] : null), "nom", array())), "html", null, true);
            echo "
</a>
";
