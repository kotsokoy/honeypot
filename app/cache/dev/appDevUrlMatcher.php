...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '/admin') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ggg_admin_homepage');
            }

            return array (  '_controller' => 'GGG\\Bundle\\AdminBundle\\Controller\\DefaultController::indexAction',  '_route' => 'ggg_admin_homepage',);
        }
        ...
        if (0 === strpos($pathinfo, '/recherche') && preg_match('#^/recherche(?:/(?P<motif>.*))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ggg_notices_recherche')), array (  '_controller' => 'GGG\\Bundle\\NoticesBundle\\Controller\\DefaultController::rechercheAction',  'motif' => NULL,));
        }
